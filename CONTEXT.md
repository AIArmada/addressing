...
- Actions/Services: `Actions/BuildAddressNavigationLinksAction`, `Actions/CreateAddressSnapshotAction`, `Actions/ExportResolutionGapAliasesAction`, `Actions/FormatAddressAction`, `Actions/IgnoreResolutionGapAction`, `Actions/ImportAddressAreasAction`, `Actions/ImportPostalCodesAction`, `Actions/LogAddressResolutionGapAction`, `Actions/MatchGapToAreaAction`, `Actions/NormalizeAddressDataAction`, `Actions/ResolveSingaporePostalCodesAction`, `Actions/SaveAddressAreaAction`, `Actions/SearchAddressAreasAction`, `Actions/SeedAddressCitiesAction`, `Actions/SeedAddressCountriesAction`, `Actions/SeedAddressCountryReferencesAction`, `Actions/SeedAddressingAction`, `Actions/SeedAddressStatesAction`, `Actions/SeedCountryGeographiesAction`, `Actions/SyncAddressAreaAssignmentsAction`
- Config `addressing.php`: `database.json_column_type`, `database.tables` (17 keys: `countries`, `areas`, `addresses`, `addressables`, `snapshots`, `states`, `cities`, `country_currency_links`, `country_timezone_links`, `area_state_links`, `area_names`, `area_roles`, `area_relationships`, `postal_codes`, `area_postal_codes`, `address_area_assignments`, `resolution_gaps`), `models`, `features.owner`, `fields`, `geography.providers`, `geography.indonesia.villages`, `formatters`, `defaults`, `seed`, `area_sources`, `onemap`
